...
const App = () => {
  ...
  const headerTitleBottom = scrollY.interpolate({
    inputRange:[0, HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT,HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT + 5 + PROFILE_IMAGE_MIN_HEIGHT, 
      HEADER_MIN_HEIGHT - HEADER_MIN_HEIGHT + 5 + PROFILE_IMAGE_MAX_HEIGHT + 26],
  ...
  return (
    <>
     ...
     <Animated.View style={{position: 'absolute', top: 0, right: 0, 
      left:0, backgroundColor:'lightskyblue', 
      height: headerHeight,
      zIndex: headerIndex,
      alignItems: 'center'
      }}>
        <Animated.View style={{position: 'absolute', bottom: headerTitleBottom}}>
          <Text style={{fontSize: 14, fontWeight: 'bold', color: 'white'}}>Peiqin Li</Text>
        </Animated.View>
      </Animated.View>
       ...
       <ScrollView style={{flex: 1}}
        ...
        >
         ...
         <View> 
           <Text style={{fontWeight: 'bold', fontSize: 26, paddingLeft: 10}}>Peiqin Li</Text>
         </View>
